// <copyright file="Union9Fifth.cs" company="Soli Deo Gloria Apps">
...
/// element with fifth of 9 possible types.
/// </summary>
...
internal sealed class Union9Fifth<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    : IUnion9<TA, TB, TC, TD, TE, TF, TG, TH, TI>
{
    ...
    /// <see cref="Union9Fifth{TA, TB, TC, TD, TE, TF, TG, TH, TI}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union9Fifth(TE value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union9Fifth<TA, TB, TC, TD, TE, TF, TG, TH, TI> fifth &&
