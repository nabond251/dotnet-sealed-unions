// <copyright file="Union8First.cs" company="Soli Deo Gloria Apps">
...
/// element with first of 8 possible types.
/// </summary>
...
internal sealed class Union8First<TA, TB, TC, TD, TE, TF, TG, TH>
    : IUnion8<TA, TB, TC, TD, TE, TF, TG, TH>
{
    ...
    /// <see cref="Union8First{TA, TB, TC, TD, TE, TF, TG, TH}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union8First(TA value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union8First<TA, TB, TC, TD, TE, TF, TG, TH> first &&
