// <copyright file="Union9Sixth.cs" company="Soli Deo Gloria Apps">
...
/// element with sixth of 9 possible types.
/// </summary>
...
internal sealed class Union9Sixth<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    : IUnion9<TA, TB, TC, TD, TE, TF, TG, TH, TI>
{
    ...
    /// <see cref="Union9Sixth{TA, TB, TC, TD, TE, TF, TG, TH, TI}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union9Sixth(TF value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union9Sixth<TA, TB, TC, TD, TE, TF, TG, TH, TI> sixth &&
