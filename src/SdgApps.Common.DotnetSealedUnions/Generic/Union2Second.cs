...
{
    /// <summary>
    /// <see cref="IUnion2{TFirst, TSecond}"/> element with
    /// first of 2 possible types.
    /// </summary>
    /// <typeparam name="TA">First possible type.</typeparam>
    /// <typeparam name="TB">Second possible type.</typeparam>
    internal sealed class Union2Second<TA, TB> : IUnion2<TA, TB>
    {
        private readonly TB value;

        /// <summary>
        /// Initializes a new instance of the <see cref="Union2Second{TA, TB}"/> class.
        /// </summary>
        ...
        /// <inheritdoc/>
        public void Continued(Action<TA> continuationFirst, Action<TB> continuationSecond)
        {
            continuationSecond(this.value);
        }

        /// <inheritdoc/>
        public TR Join<TR>(Func<TA, TR> mapFirst, Func<TB, TR> mapSecond)
        {
