// <copyright file="Union9Third.cs" company="Soli Deo Gloria Apps">
...
/// element with third of 9 possible types.
/// </summary>
...
internal sealed class Union9Third<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    : IUnion9<TA, TB, TC, TD, TE, TF, TG, TH, TI>
{
    ...
    /// <see cref="Union9Third{TA, TB, TC, TD, TE, TF, TG, TH, TI}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union9Third(TC value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union9Third<TA, TB, TC, TD, TE, TF, TG, TH, TI> third &&
