// <copyright file="Union9Ninth.cs" company="Soli Deo Gloria Apps">
...
/// element with ninth of 9 possible types.
/// </summary>
...
internal sealed class Union9Ninth<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    : IUnion9<TA, TB, TC, TD, TE, TF, TG, TH, TI>
{
    private readonly TI value;

    /// <summary>
    /// Initializes a new instance of the
    /// <see cref="Union9Ninth{TA, TB, TC, TD, TE, TF, TG, TH, TI}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union9Ninth(TI value)
    {
        this.value = value;
    }
    ...
    public TR Join<TR>(
        ...
        Func<TI, TR> mapNinth)
    {
        return mapNinth(this.value);
    }

    /// <inheritdoc/>
    public override bool Equals(object? obj)
    {
        return obj is Union9Ninth<TA, TB, TC, TD, TE, TF, TG, TH, TI> ninth &&
            EqualityComparer<TI>.Default.Equals(this.value, ninth.value);
    }
    ...
    {
#if NETSTANDARD2_0
        return -1584136870 + EqualityComparer<TI>.Default.GetHashCode(this.value);
#else
