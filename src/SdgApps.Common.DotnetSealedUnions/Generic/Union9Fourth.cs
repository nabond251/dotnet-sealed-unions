// <copyright file="Union9Fourth.cs" company="Soli Deo Gloria Apps">
...
/// element with fourth of 9 possible types.
/// </summary>
...
internal sealed class Union9Fourth<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    : IUnion9<TA, TB, TC, TD, TE, TF, TG, TH, TI>
{
    ...
    /// <see cref="Union9Fourth{TA, TB, TC, TD, TE, TF, TG, TH, TI}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union9Fourth(TD value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union9Fourth<TA, TB, TC, TD, TE, TF, TG, TH, TI> fourth &&
