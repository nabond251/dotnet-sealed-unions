...
namespace SdgApps.Common.DotnetSealedUnions.Generic
{
    ...
    internal sealed class Union4Second<TA, TB, TC, TD> : IUnion4<TA, TB, TC, TD>
    {
        private readonly TB value;

        /// <summary>
        /// Initializes a new instance of the <see cref="Union4Second{TA, TB, TC, TD}"/> class.
        /// </summary>
