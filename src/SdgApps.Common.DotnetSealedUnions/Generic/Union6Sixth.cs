// <copyright file="Union6Sixth.cs" company="Soli Deo Gloria Apps">
...
/// element with sixth of 6 possible types.
/// </summary>
...
internal sealed class Union6Sixth<TA, TB, TC, TD, TE, TF>
    : IUnion6<TA, TB, TC, TD, TE, TF>
{
    ...
    /// <see cref="Union6Sixth{TA, TB, TC, TD, TE, TF}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union6Sixth(TF value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union6Sixth<TA, TB, TC, TD, TE, TF> sixth &&
