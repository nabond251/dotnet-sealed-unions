// <copyright file="Union7Sixth.cs" company="Soli Deo Gloria Apps">
...
/// element with sixth of 7 possible types.
/// </summary>
...
internal sealed class Union7Sixth<TA, TB, TC, TD, TE, TF, TG>
    : IUnion7<TA, TB, TC, TD, TE, TF, TG>
{
    ...
    /// <see cref="Union7Sixth{TA, TB, TC, TD, TE, TF, TG}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union7Sixth(TF value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union7Sixth<TA, TB, TC, TD, TE, TF, TG> sixth &&
