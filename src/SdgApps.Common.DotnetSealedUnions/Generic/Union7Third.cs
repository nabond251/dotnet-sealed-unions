// <copyright file="Union7Third.cs" company="Soli Deo Gloria Apps">
...
/// element with third of 7 possible types.
/// </summary>
...
internal sealed class Union7Third<TA, TB, TC, TD, TE, TF, TG>
    : IUnion7<TA, TB, TC, TD, TE, TF, TG>
{
    ...
    /// <see cref="Union7Third{TA, TB, TC, TD, TE, TF, TG}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union7Third(TC value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union7Third<TA, TB, TC, TD, TE, TF, TG> third &&
