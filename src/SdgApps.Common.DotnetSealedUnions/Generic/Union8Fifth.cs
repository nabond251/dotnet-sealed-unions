// <copyright file="Union8Fifth.cs" company="Soli Deo Gloria Apps">
...
/// element with fifth of 8 possible types.
/// </summary>
...
internal sealed class Union8Fifth<TA, TB, TC, TD, TE, TF, TG, TH>
    : IUnion8<TA, TB, TC, TD, TE, TF, TG, TH>
{
    ...
    /// <see cref="Union8Fifth{TA, TB, TC, TD, TE, TF, TG, TH}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union8Fifth(TE value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union8Fifth<TA, TB, TC, TD, TE, TF, TG, TH> fifth &&
