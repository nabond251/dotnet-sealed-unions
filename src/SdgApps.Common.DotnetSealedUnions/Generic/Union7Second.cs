// <copyright file="Union7Second.cs" company="Soli Deo Gloria Apps">
...
/// element with second of 7 possible types.
/// </summary>
...
internal sealed class Union7Second<TA, TB, TC, TD, TE, TF, TG>
    : IUnion7<TA, TB, TC, TD, TE, TF, TG>
{
    ...
    /// <see cref="Union7Second{TA, TB, TC, TD, TE, TF, TG}"/> class.
    /// </summary>
    /// <param name="value">Element value.</param>
    public Union7Second(TB value)
    {
        this.value = value;
    }
    ...
    {
        return obj is Union7Second<TA, TB, TC, TD, TE, TF, TG> second &&
