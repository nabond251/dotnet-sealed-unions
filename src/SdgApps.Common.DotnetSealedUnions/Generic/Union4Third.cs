...
namespace SdgApps.Common.DotnetSealedUnions.Generic
{
    ...
    internal sealed class Union4Third<TA, TB, TC, TD> : IUnion4<TA, TB, TC, TD>
    {
        private readonly TC value;

        /// <summary>
        /// Initializes a new instance of the <see cref="Union4Third{TA, TB, TC, TD}"/> class.
        /// </summary>
