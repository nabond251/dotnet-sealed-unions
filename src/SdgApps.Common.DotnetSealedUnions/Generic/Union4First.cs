...
namespace SdgApps.Common.DotnetSealedUnions.Generic
{
    ...
    internal sealed class Union4First<TA, TB, TC, TD> : IUnion4<TA, TB, TC, TD>
    {
        private readonly TA value;

        /// <summary>
        /// Initializes a new instance of the <see cref="Union4First{TA, TB, TC, TD}"/> class.
        /// </summary>
